...
<body class="font-sans antialiased h-full flex overflow-hidden">
    ...
    <aside class="w-64 flex-shrink-0 {{ $sidebarBg }} text-white flex flex-col transition-colors duration-300">
        <!-- Logo -->
        ...
        <nav class="flex-1 px-4 space-y-2 mt-4">
            ...
            @else
                ...
                <a href="{{ route('allowances.index') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-md w-full hover:bg-white/10 transition-colors {{ request()->routeIs('allowances.*') ? 'bg-white/10' : '' }}">
                     <svg class="mr-3 h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
