...
<div class="max-w-6xl mx-auto space-y-8" x-data="{ 
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
            ...
            <p class="text-2xl font-bold text-green-600 mt-1">{{ $payments->where('paymentStatus', 'approved')->count() }}</p>
        </div>
        <!-- Paid -->
        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($payments->where('paymentStatus', 'paid')->sum('amount')) }}</p>
        </div>
    </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <div class="mt-3 space-y-1">
                            <p class="text-sm font-medium text-gray-800">Amount: ₱ {{ number_format($payment->amount) }}</p>
