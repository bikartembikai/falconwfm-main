...
@section('content')
<!-- Modal-like Container to match design -->
<div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity flex items-center justify-center p-4 z-50">
    <!-- Card -->
    <div class="bg-white rounded-lg shadow-xl transform transition-all sm:max-w-2xl w-full overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
            ...
            <a href="{{ route('events.index') }}" class="text-gray-400 hover:text-gray-500">
        ...
        <div class="px-6 py-6">
            ...
            <div class="bg-blue-50 rounded-lg p-4 mb-6 border border-blue-100">
                ...
                <ul class="space-y-1">
                    <li class="flex text-sm text-blue-800">
                        ...
                        {{ $rule && $rule->requiredSkill ? implode(', ', $rule->requiredSkill) : 'None' }}
                    </li>
                    <li class="flex text-sm text-blue-800">
                        <span class="w-1.5 h-1.5 bg-blue-400 rounded-full mt-1.5 mr-2"></span>
            ...
            <div class="flex justify-end">
                <a href="{{ route('events.index') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Close
                </a>
            </div>
        </div>
